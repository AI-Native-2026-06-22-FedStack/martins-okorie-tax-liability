...
- [docs/boundaries.md](docs/boundaries.md) for the Core Case Service and Tax Engine bounded-context map and anti-shared-DB rule.
- [docs/adr/0009-storage-decision-matrix.md](docs/adr/0009-storage-decision-matrix.md) for the Storage Decision Matrix and store placements.

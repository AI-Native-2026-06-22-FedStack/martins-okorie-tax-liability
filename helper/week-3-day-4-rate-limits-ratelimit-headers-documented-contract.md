...
- **IETF RateLimit headers draft**: (draft-ietf-httpapi-ratelimit-headers, not RFC 9239). Emits remaining budget `RateLimit: limit=X, remaining=Y, reset=Z` and policy `RateLimit-Policy`.
